function Clock() {
	...
	this.defaults = {
		...
		display : {
			color : {
				background : "000",		// String, 3 or 6 digit hex RGB color with optional '#'
				active : "FFF",			// String, 3 or 6 digit hex RGB color with optional '#'
				inactive : "333"		// String, 3 or 6 digit hex RGB color with optional '#'
			},
...
Clock.prototype.isValidColor = function(color) {
	...
	color = /^#?([0-9A-Fa-f]{3}){1,2}$/.exec(color);
